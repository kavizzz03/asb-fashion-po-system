                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right; padding-right:24px !important;">
                                        <div style="display: inline-flex; gap: 6px; align-items: center; flex-wrap: wrap; justify-content: flex-end;">
                                            ...
                                            <?php else: ?>
                                                <button class="btn-asb-action" style="background: #f5f5f5; color: #aaa; border: 1px solid #ddd; padding: 6px 12px; font-size: 12px; box-shadow: none; cursor: not-allowed;" disabled>🚫 No Items</button>
                                            <?php endif; ?>
